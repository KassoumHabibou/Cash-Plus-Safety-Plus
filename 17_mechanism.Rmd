...
## Mechanism 1 : Economic Security & Emotional Well-being
...
mainResults_mech_hh <- map_dfr(revenue_consum_vars_hh, function(depvar) {
    ...
    tempResults2 <- map_dfr(treatment_vars, function(treat_var) {
      ...
      bind_rows(
        ...
        getEstimate_mechanism(depvar, treat_var, control_vars, strata_vars, cluster_vars, followup_MRT_hh) %>%
...
tbl <- getTable1_het(revenue_consum_vars_hh, mainResults_mech_hh)
tbl
```
...
# Extract results for the outcome variable 
tbl <- getTable2_het(revenue_consum_vars_ben, mainResults_mech_ben)
tbl
```
