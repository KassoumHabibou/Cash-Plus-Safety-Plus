...
#followup_MRT_hh <- readRDS(paste0(getwd(),"/followup_MRT_hh_imptd.rds"))
...
mainResults_het <- mainResults_het %>%
    mutate(
      ...
      het_var = dplyr::recode(het_var,
                      ...
                      het_age_gap = "Age gap (partner - benef.)",
      ...
      estimate = dplyr::recode(
        ...
        depvar = dplyr::recode(depvar,
              ...
              all_ipv_sev_12m = "Bin. for at least one type of IPV (exclu. eco.)", 
              all_ipv_sev_index = "All IPV inten. index"
      )
      )
...
mainResults_reg_group %>%
  ...
  facet_grid(depvar~name, scales = "free", space="free", shrink=TRUE, drop=TRUE) +
