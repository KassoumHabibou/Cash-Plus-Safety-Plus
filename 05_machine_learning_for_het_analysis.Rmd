...
# Create df_curr2 by filtering households registered for the Economic Inclusion program (reg_hh_pi_mrt == 1)
df_curr2 <- df_curr2 %>%
  mutate(
...
mainResults_reg_group %>%
  ...
  labs(
    ...
    caption = sprintf(paste0("N = %s Tekavoul, %s Economic Inclusion."), 
